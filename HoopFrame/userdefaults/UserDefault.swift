...
struct UserDefault<T: PropertyListValue> {
    ...
    var wrappedValue: T? {
        get { UserDefaults(suiteName: Constants.appGroupId)!.value(forKey: key.rawValue) as? T ?? defaultValue }
        set { UserDefaults(suiteName: Constants.appGroupId)!.set(newValue, forKey: key.rawValue) }
    }
